...
This is a simple guide for people who are not developers.

It answers three questions:

1. **What** each step does
2. **Where** it should be run
3. **How** to run it and what a successful result looks like

> **Note:** This guide does not replace the detailed technical documents.
>
> - For full technical steps, see [SCRIPT-TESTING-GUIDE.md](SCRIPT-TESTING-GUIDE.md)
> - For product detail, see [README.md](README.md)
> - For server names and folders, see [SERVERS.md](SERVERS.md)
